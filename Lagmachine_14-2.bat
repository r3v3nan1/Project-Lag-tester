...
title NETWORK MASTER CONTROL v14.1
...
echo  ^|             [ VERSION : 14.1 Build PERSIST ]              ^|
echo  +-----------------------------------------------------------+
echo  ^|  IP      : %my_ip%                                        
...
echo  +-----------------------------------------------------------+
echo.
echo     START MONITOR      LIGHT (5)       MEDIUM (15)
echo     HEAVY (30)         CUSTOM          NUKE / RESET
echo     VISUAL SETTINGS    GITHUB PAGE     EXIT PROGRAM
echo.
echo  +---[ v14.1 CHANGELOG ]-------------------------------------+
echo  ^| + Extended Startup Sequence to 6.0 Seconds               ^|
echo  ^| + Integrated GitHub Repo Link: /r3v3nan1/                ^|
echo  ^| + Persistence Engine: Theme Saves to Temp Folder          ^|
echo  +-----------------------------------------------------------+
echo.
