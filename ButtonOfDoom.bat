...
title NETWORK MASTER CONTROL v13.8
...
echo  ^|             [ VERSION : 13.8 Build MATRIX ]               ^|
echo  +-----------------------------------------------------------+
echo  ^|  IP      : %my_ip%                                        
...
echo     [8] EXIT PROGRAM
echo.
echo  +---[ v13.8 CHANGELOG ]-------------------------------------+
echo  ^| + Expanded Color Matrix to 8 Selectable Themes           ^|
echo  ^| + Added Full Vertical Option List for Clarity            ^|
echo  ^| + Optimized Menu Selection Logic                         ^|
echo  +-----------------------------------------------------------+
echo.
...
echo  +-----------------------------------------------------------+
echo.
echo     [1] GREEN  (Matrix)     [5] AQUA   (Cyber)
echo.
echo     [2] AMBER  (Vintage)    [6] PURPLE (Neon)
echo.
echo     [3] BLUE   (Modern)     [7] RED    (Warning)
echo.
echo     [4] WHITE  (Classic)    [8] GRAY   (Stealth)
echo.
